...
int main(int argc, char* argv[]) {
    ...
    // Parse matrix size and number of threads from command line
    n = atoi(argv[1]);
    ...
    if (csv_file != NULL) {
        fprintf(csv_file, "openmp,%d,%d,%.9f\n", n, num_threads, execution_time);
        fclose(csv_file);
    } else {
...
// # Run with different matrix sizes and thread counts
// ./matrix_mult_omp.out 100 4    # 100x100 matrices with 4 threads